...
public class RequestQueue {
    ...
    /**
     * before request real add to mCacheQueue
     */
    ...
    /**
     * before request set cache
     * @param beforeRequestListener
     */
    public void changeCacheSettingBeforeRequest(BeforeRequestListener beforeRequestListener){
        this.beforeRequestListener = beforeRequestListener;
    }
        ...
        synchronized (mWaitingRequests) {
            ...
            if (mWaitingRequests.containsKey(cacheKey)) {
                ...
                if(beforeRequestListener!=null){
                    Queue<Request<?>> addRequests = new LinkedList<Request<?>>();
                    addRequests.add(request);
                    beforeRequestListener.beforeRequest(addRequests);
                }
        ...
        if (request.shouldCache()) {
            synchronized (mWaitingRequests) {
                ...
                if (waitingRequests != null) {
                    ...
                    if(beforeRequestListener!=null){
                        beforeRequestListener.beforeRequest(waitingRequests);
                    }
