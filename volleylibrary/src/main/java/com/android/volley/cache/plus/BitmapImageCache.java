...
public class BitmapImageCache implements ImageCache {
    ...
    /**
     * Find and return an existing BitmapCache stored in a {@link com.android.volley.cache.plus.BitmapImageCache.RetainFragment}, if not found a
     * new one is created using the supplied params and saved to a {@link com.android.volley.cache.plus.BitmapImageCache.RetainFragment}.
     *
