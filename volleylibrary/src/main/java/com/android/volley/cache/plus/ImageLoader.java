 ...
 *
 * The simple way to use this class is to call {@link com.android.volley.cache.plus.ImageLoader#get(String, com.android.volley.cache.plus.ImageLoader.ImageListener)}
 * and to pass in the default image listener provided by
 * {@link com.android.volley.cache.plus.ImageLoader#getImageListener(android.widget.ImageView, int, int)}. Note that all function calls to
...
public class ImageLoader {
    ...
    /** {@link android.content.ContentResolver} instance for loading content uris */
     ...
     * If the default was returned, the {@link com.android.volley.cache.plus.ImageLoader} will be invoked when the
...
/*        Response<?> response = Response.success(bitmap, HttpHeaderParser.parseBitmapCacheHeaders(bitmap));
     ...
     * @param resources {@link android.content.res.Resources} instance for loading images. Get from {@link android.content.Context#getResources()}
     */
    ...
    /**
     * Set a {@link android.content.ContentResolver} instance if you need to support content uris for loading images
     * @param resources {@link android.content.ContentResolver} instance for loading images. Get from {@link android.content.Context#getContentResolver()}
     */
